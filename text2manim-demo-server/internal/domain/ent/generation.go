...
func (*Generation) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case generation.FieldRequestID, generation.FieldPrompt, generation.FieldStatus, generation.FieldVideoURL, generation.FieldScriptURL, generation.FieldErrorMessage, generation.FieldEmail:
...
func (ge *Generation) String() string {
	...
	builder.WriteString(ge.RequestID)
	builder.WriteString(", ")
